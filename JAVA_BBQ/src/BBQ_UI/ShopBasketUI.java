...
//	      center_panel.setBackground(Color.green);
	      ...
	      btn_back.setBounds(0, 10, 50, 40);
	      btn_back.setPreferredSize(new Dimension(50, 50));
	      
	      btn_all_delete = new JButton("전체삭제");
	      btn_all_delete.setFont(Commons.getFont(15));
	      top_panel.add(BorderLayout.WEST, new JPanel(new GridLayout(1, 1)).add(btn_back));
	      JLabel mainname = new JLabel("                                    장바구니");
	      mainname.setFont(Commons.getFont(15));
	      top_panel.add(mainname);
	      ...
	      btn_order.setFont(Commons.getFont(15));
...
//	      panel_content.add(btn_order);
	      ...
	      btn_pay.setFont(Commons.getFont(20));
...
//				f.add(pc,BorderLayout.CENTER);
		      ...
		      btn_mdelete.setBounds(215, 0, 40, 38);
		      ...
		      count_panel.setBounds(55, 45, 300, 60);
