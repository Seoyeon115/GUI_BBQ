...
//		frame.getContentPane().setLayout(null);
		...
		ImageIcon icon1 = new ImageIcon("image/normal.png");
		ImageIcon icon2 = new ImageIcon("image/half.png");
		ImageIcon icon3 = new ImageIcon("image/rip.png");
		...
		ImageIcon point = new ImageIcon("image/rightr.png");
		ImageIcon point2 = new ImageIcon("image/righty.png");
